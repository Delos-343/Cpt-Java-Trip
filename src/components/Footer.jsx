...
<footer className="bg-stone-900 p-4 shadow md:px-6 md:py-6">
  <div className='flex'>
    <div className='w-50 flex mx-auto md:gap-10 gap-5'>
      <a href="" className="fill-white transition-colors hover:fill-yellow-100">
    ...
    <hr class="my-4 border-stone-600 sm:mx-auto " />
