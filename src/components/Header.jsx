...
const Header = () => {
  return (
    <nav className="w-full px-2 sm:px-4 py-1 bg-stone-900">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
            ...
            */}
            <div className="items-stretch justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                <ul className="flex flex-col p-4 mt-4 border-stone-900 rounded-lg md:flex-row md:space-x-20 md:mt-0 md:text-sm md:font-medium">
                    <li className="align-middle my-auto">
                        <a href="/home" className="block text-stone-500 active:text-gray-200 bg-yellow-700 rounded md:bg-transparent md:p-0 dark:text-white" aria-current="page">
                            Home
                        </a>
                    </li>
                    <li className="align-middle my-auto">
                        <a href="/our-routes" className="block text-stone-500 active:text-gray-200 rounded hover:bg-stone-100 md:hover:bg-transparent md:hover:text-yellow-700 md:p-0 md:dark:hover:text-white dark:text-stone-400 dark:hover:bg-stone-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-stone-700">
                            Our Routes
                        </a>
                    </li>
                    <li className="align-middle my-auto">
                        <a href="/our-spots" className="block text-stone-500 active:text-gray-200 rounded hover:bg-stone-100 md:hover:bg-transparent md:hover:text-yellow-700 md:p-0 md:dark:hover:text-white dark:text-stone-400 dark:hover:bg-stone-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-stone-700">
                            Our Spots
                        </a>
                    </li>
                    <li>
