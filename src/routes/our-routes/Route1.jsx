...
const Route1 = () => {
  return (
    <div>
      <img src="/images/jakarta-panorama.jpg" alt="Route Image" className='object-cover w-full lg:h-72 h-48 mb-6'/>
      ...
      <div className='flex align-middle'>
          <a href="/map/1" className='text-white text-2xl text-center bg-yellow-600 mx-auto mb-8 px-14 py-3 transition-colors hover:bg-yellow-500'>
              View in map
          </a>
      </div>
