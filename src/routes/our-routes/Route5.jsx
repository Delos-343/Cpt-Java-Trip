...
const Route5 = () => {
  return (
    <div>
      <img src="/images/sunrise.jpg" alt="Route Image" className='object-cover w-full lg:h-72 h-48 mb-6'/>
      <div className='lg:mx-40 md:mx-10 mx-8'>
        ...
        <p className='text-stone-800 text-center py-4'>
          Love taking scenic photos? This route will provide you the best photo you can get in java! visit!
        </p>
      ...
      <div className='flex align-middle'>
          <a href="/map/5" className='text-white text-2xl text-center bg-yellow-600 mx-auto mb-8 px-14 py-3 transition-colors hover:bg-yellow-500'>
              View in map
          </a>
      </div>
